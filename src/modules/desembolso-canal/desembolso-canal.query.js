/**
 * Query SQL del reporte mensual Desembolso Canal
 * (fuente: .docs/MENSUALES/Desembolso Canal/Desembolsos_canal.sql)
 */

module.exports = {
  /**
   * Desembolsos por canal (BT/CT) al cierre de mes
   * @param {string} fecha - Fecha de cierre en formato YYYYMMDD (ej. '20260630')
   */
  obtenerDesembolsosCanal: (fecha) => `
    declare @val float

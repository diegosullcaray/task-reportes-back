/**
 * Query SQL del reporte mensual "Saca tu Garra" (Reporte Giancarlo)
 * (fuente: .docs/MENSUALES/Reporte Giancarlo/Query.sql)
 */

module.exports = {
  /**
   * Variación de saldo vigente, productividad y ratios de recuperación por
   * asesor (HASEOPER) entre el cierre y el mes anterior.
   * @param {string} fecha - Fecha de cierre en formato YYYYMMDD (ej. '20260630')
   */
  obtenerSacaTuGarra: (fecha) => `
    use storage;
    declare @fech date ='${fecha}'
